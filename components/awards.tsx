        ...
        <div className="grid grid-cols-2 gap-6">
          {awards.map((award, index) => (
            <div key={index} className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-secondary flex items-center justify-center mb-3 overflow-hidden">
                <img
              ...
              <p className="text-xs font-serif text-foreground whitespace-pre-line">
                {award.name}
              </p>
            </div>
          ))}
